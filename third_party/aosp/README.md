...
| File | Why it is here |
|---|---|
| `CalendarContract.java` | The provider's public schema: every table and column the app reads and writes. `scripts/field-table.py` parses this file, so `docs/field-table.md` cannot drift from the platform. |
